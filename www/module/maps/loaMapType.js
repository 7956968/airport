...
var baiduMercatorProject = new ol.proj.Projection({
    code: "baidu",
...
ol.proj.addProjection(baiduMercatorProject);
ol.proj.addCoordinateTransforms('EPSG:4326', baiduMercatorProject, projzh.ll2bmerc, projzh.bmerc2ll);
ol.proj.addCoordinateTransforms('EPSG:3857', baiduMercatorProject, projzh.smerc2bmerc, projzh.bmerc2smerc);
var loadMapType = {
        ...
        return {
            "vector": new ol.layer.Tile({
                source: new ol.source.XYZ({
                    projection: baiduMercatorProject,
                    tileGrid: tileGrid,
                    tileUrlFunction: function (tileCoord, pixelRatio, proj) {
                        ...
                        return 'http://online9.map.bdimg.com/onlinelabel/?qt=tile&x=' + x + '&y=' + y + '&z=' + z + '&styles=pl&udt=20180303&scaler=1&p=110';
                    }
                })
            }),
                ...
                source: new ol.source.XYZ({
                    ...
                    tileUrlFunction: function (tileCoord, pixelRatio, proj) {
                        ...
                        return 'http://shangetu' + parseInt(Math.random() * 10) + '.map.bdimg.com/it/u=x=' + x +
                            ';y=' + y + ';z=' + z + ';v=009;type=sate&fm=46&udt=20180303';;
                    }
                })
            })
        };
